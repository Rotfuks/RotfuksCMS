...
export default {
  Query: {
    navbar: (parent) => {
      return navigationService.getNavbar();
    },
    navLinks: (parent) => {
      return navigationService.getAllNavLinks();
    },
    navLink: (parent, args) => {
      return navigationService.getNavLink(args._id);
    },
  },
  Mutation: {
    ...
    deleteNavLink: (parent, args, context) => {
      if (authService.verifyToken(context.req, context.res, context.next)) {
        return navigationService.deleteNavLink(args._id)
